...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
 ...
 <xsl:template match="page">
  <html>
   ...
   <head>
    ...
    <script src="http://www.freecast.org/start.js" type="text/javascript">
 ...
 <div id="sidebar">
   <div id="menu">
    ...
    <h3><img src="images/nav/play.png" alt=""/> 
     <xsl:choose>
      <xsl:when test="'fr'=$lang">
       Ecouter
      </xsl:when>
      <xsl:otherwise>
       Listen
    ...
    <ul>
     <li><a href="listen">FreeCast Networks</a></li>
    </ul>
