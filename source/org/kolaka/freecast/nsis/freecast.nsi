; Taken from http://nsis.sourceforge.net/archive/viewpage.php?pageid=268 by weebib
; Use it as you desire.
 
; Credit given to so many people of the NSIS forum.
 
!define AppName "FreeCast"
!define AppVersion "@project.version@"
!define ShortName "FreeCast"
!define JRE_VERSION "1.4.1"
!define Vendor "Kolaka Team"
...
Section "Start menu shortcuts" SecCreateShortcut
  ...
  CreateShortCut "$SMPROGRAMS\${AppName}\Freecast Website.lnk" "http://www.freecast.org/"
  CreateShortCut "$SMPROGRAMS\${AppName}\FreeCast UserGuide.lnk" "$INSTDIR\docs\userguide\index.html"
  CreateShortCut "$SMPROGRAMS\${AppName}\FreeCast Manager.lnk" "$INSTDIR\bin\freecast-manager.bat"
