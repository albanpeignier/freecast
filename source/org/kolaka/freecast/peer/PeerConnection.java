...
public abstract class PeerConnection {
    ...
    protected PeerConnection(Type type/* Peer peer, PeerReference peerReference */) {
        this.type = type;
        /*
         * this.peer = peer; this.peerReference = peerReference;
         */
    }
    ...
    private PeerConnectionStatusSupport support = new PeerConnectionStatusSupport(
            this);
    ...
    class SendStatusTask extends Task {
        ...
        public void run() {
            NDC.push(PeerConnection.this.toString());
    ...
    class CheckReceivedStatusTask extends Task {
        ...
        public void run() {
            ...
            if (now - lastPeerStatusUpdate > DefaultTimer.minutes(1)) {
                String msg = "status update timeout on " + PeerConnection.this
